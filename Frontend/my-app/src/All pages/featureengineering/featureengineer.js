...
//     const [selectKBest, setSelectKBest] = useState(null); // State for SelectKBest
//     const [kValue, setKValue] = useState(5); // State for K value
...
//             setPca(item);
//         } else {
//             setPca(null); // Reset pca state when another item is clicked
//         }
//         setSelectKBest(item);
//     };
...
//                                             <Button onClick={() => setPca(null)}>Cancel</Button> {/* Add Cancel button */}
//                                         </li>
//                                         {/* Include other extraction options */}
//                                     </ul>
//                                 )}
...
//     const handleConfirmTargetColumn = (method, text) => {
...
//             alert('Error processing the data');
//         } finally {
//             setIsSelectingTargetColumn(false); // Reset state when done
//         }
//     };
...
//                 return (
//                     <ul style={{ listStyleType: 'none', padding: '10px', textAlign: 'left' }}>
//                         <li style={{ marginBottom: '7px' }} onClick={() => handleConfirmTargetColumn('randomforest', 'Randomforest')}>
//                             <ArrowRightIcon /> Randomforest
//                         </li>
...
//                                         ))}
//                                     </select>
//                                     <span onClick={handleFeatureImportance}><CheckIcon style={{ fontSize: 'larger', position: 'relative', top: '5px', left: '10px' }} /></span>
...
//     console.log("featureImportance",featureData)
//     const [selectedTechnique, setSelectedTechnique] = useState(null);
//     const [numComponents, setNumComponents] = useState(2);
//     const [selectKBest, setSelectKBest] = useState(null); // State for SelectKBest
//     const [kValue, setKValue] = useState(5); // State for K value
...
//         setIsSelectingTargetColumn(true);
//         setSelectedAlgorithm(algorithm); // Set the selected algorithm
//         setSelectedTechnique(text);
//     };
...
//                 return (
//                     <ul style={{ listStyleType: 'none', padding: '10px', textAlign: 'left' }}>
//                         <li style={{ marginBottom: '7px' }} onClick={() => handleConfirmTargetColumn('Random Forest', 'Randomforest')}>
//                             <ArrowRightIcon /> Randomforest
//                         </li>
//                         <li style={{ marginBottom: '7px' }} onClick={() => handleConfirmTargetColumn('XGBoost', 'XGboost')}>
//                             <ArrowRightIcon /> XGboost
...
//     // Inside the handleFeatureImportance function
//     const handleFeatureImportance = async () => {
//         try {
//             if (!targetColumn) {
//                 alert('Please select a target column');
...
//             // setPlotUrl(`http://127.0.0.1:5000${response.data.plot_url}`);
...
//             </div>
//             {featureRanking && (
//                 <div className="feature-ranking-container">
...
//                 <div>
//                     <h2>Plot</h2>
//                     <img src={plotUrl} alt="Feature Importance Plot" style={{ maxWidth: '100%' }} />
//                 </div>
//             )}
//         </>
//     );
...
//     const [featureRanking, setFeatureRanking] = useState(null);
//     const [plotUrl, setPlotUrl] = useState(null);
//     const [loadingPlot, setLoadingPlot] = useState(false); // New state for loading plot
...
//             setLoadingPlot(true); // Set loading state
...
//             alert('Error processing the data');
//         } finally {
//             setLoadingPlot(false); // Clear loading state
//             setIsSelectingTargetColumn(false);
//         }
//     };
...
//                         <p>Loading plot...</p>
//                     ) : (
//                         <img src={plotUrl} alt="Feature Importance Plot" style={{ maxWidth: '52%',position:'relative',bottom:'40px',left:'370px' }} />
//                     )}
//                 </div>
//             ) : (
//                 dataToDisplay && (
...
export default function Featureengineer() {
    ...
    return (
        <>
                        ...
                        <ul style={{ listStyleType: 'none', padding: 0 }}>
                            ...
                            {isSelectingTargetColumn ? (
                                <div>
                                    ...
                                    <span onClick={()=>handleFeatureImportance('Randomforest')}><CheckIcon style={{ fontSize: 'larger', position: 'relative', top: '5px', left: '10px' }} /></span>
                                    <span onClick={handleCancelTargetColumnSelection}><CloseIcon style={{ fontSize: 'larger', position: 'relative', top: '5px', left: '15px' }} /></span>
                                </div>
                            ) : (
                                <li
            ...
            {featureRanking && selectedTechnique === 'Randomforest' && (
                <div id='featuretable'>
                    <span id='FeatureRanking'>Feature Ranking</span>
                    <ul style={{ listStyleType: 'none', padding: '10px', textAlign: 'left' }}>
                        {featureRanking.map((feature, index) => (
